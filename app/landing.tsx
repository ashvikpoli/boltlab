  ...
  const features = [
    {
      ...
      description: 'High-intensity training sessions designed for maximum results',
      color: '#6B46C1',
    },
    {
      icon: Target,
      ...
      >
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroSubtitle}>
            Join the lightning-fast fitness revolution with workouts designed to energize and transform your body
          </Text>
